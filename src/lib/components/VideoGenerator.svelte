...
<div class="glass-effect rounded-xl overflow-hidden">
	...
	>
		...
		<button
			type="submit"
			class="btn group bg-linear-to-r ring-transparent ring-2 duration-300 from-purple-700 to-cyan-600 w-full flex items-center justify-center gap-2 {(
				isGenerating || !$apiKey
			) ?
				'opacity-50 cursor-not-allowed'
			:	'hover:ring-white cursor-pointer'}"
